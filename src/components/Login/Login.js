    ...
    return (
        <div style={{ position: 'relative', top: '-70px' }} className='container'>
            ...
            <form className='login-form'>
                ...
                <div className="mb-3">
                    <input type="email" className="form-control w-50 form-text" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder='Email' />
                </div>
                <div className="mb-3">
                    <input type="password" className="form-control w-50 form-text" id="exampleInputPassword1" placeholder='Password' />
                </div>
